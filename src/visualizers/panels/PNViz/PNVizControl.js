...
define([
    ...
    PNVizControl.prototype._initSM = function () {
        ...
        const sm = { init: "/Q/h", places: {}, marking: 0};
        elementIds.forEach(elementId => {
            ...
            if (node.isTypeOf(META['Place']) || node.isTypeOf(META['Transition'])) {
                ...
                const place = { name: node.getAttribute('name'), next: {}, marking: node.getAttribute('marking') || 0, position: node.getRegistry('position'), isTransition: node.isTypeOf(META['Transition'])}; //REMOVE IS END field var
                ...
                //TODO - does PN need init/end or do I remove this?
        ...
        //IM HERE
        console.log("*** SM BEFORE WIDGET CALL ***")
        console.log(sm)
